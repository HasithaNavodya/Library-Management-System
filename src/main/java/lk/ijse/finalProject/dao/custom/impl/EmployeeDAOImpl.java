...
public class EmployeeDAOImpl implements EmployeeDAO {
    ...
    public boolean save(Employee employee) throws SQLException {
        return SQLUtil.execute("INSERT INTO employee (employee_id,employee_name,status,address,contact_no) VALUES (?,?,?,?,?)", employee.getEmployee_id(),employee.getEmployee_name(),employee.getStatus(),employee.getAddress(),employee.getContact_no());
