...
//    }
//
//    public static boolean placeIssue(BorrowBooksDTO dto) throws SQLException {
//        Connection con = null;
//        try {
...
//    }
//
//    private static boolean saveDonation(String issue_id, String mem_id, String due_date, List<BorrowBooksDTO> borrowBooksList) throws SQLException {
//        for(BorrowBooksDTO borrowBooks : borrowBooksList) {
...
//    }
//
//    private static boolean save(String issue_id, String mem_id, String due_date, BorrowBooksDTO borrowBooks) throws SQLException {
