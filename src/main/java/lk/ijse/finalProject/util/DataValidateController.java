...
public class DataValidateController {
    ...
    public static boolean memberId(String id) {
        String customerRegex = "^(M)[0-9]{3}$";
        Pattern pattern = Pattern.compile(customerRegex);
        Matcher matcher = pattern.matcher(id);
        return matcher.matches();
    }

    public static boolean fineId(String id) {
    ...
    public static boolean donatorIdValidate(String custId) {
        String customerRegex = "^(D)[0-9]{3}$";
        Pattern pattern = Pattern.compile(customerRegex);
        Matcher matcher = pattern.matcher(custId);
        return matcher.matches();
    }
